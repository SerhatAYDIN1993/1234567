...
exports.conf = {
    ...
    exports.help = {
    name: 'çalan', 
    description: 'Sunucuda ID Sinini Belirtilen Kişinin Banını Kaldırır.',
    usage: '&çalan'  
    };